...
```
kubectl apply --server-side -k https://github.com/vllm-project/aibrix/tree/main/config/dependency
```
...
```
kubectl apply --server-side -k https://github.com/danchev/helm-charts/charts/aibrix/cdrs
```
